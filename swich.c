...
int main()
{
    ...
    switch(n)
    {
        ...
        break;
         case 91:printf("ninty one");
        break;
         case 92:printf("ninty two");
        break;
         case 93:printf("ninty three");
        break;
         case 94:printf(" ninty four");
        break;
         case 95:printf("ninty five");
        break;
         case 96:printf("ninty six");
        break;
         case 97:printf("ninty seven");
        break;
         case 98:printf("ninty eight");
        break;
         case 99:printf("ninty nine");
        break;
